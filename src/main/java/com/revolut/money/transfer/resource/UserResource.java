...
public class UserResource {
    ...
    public User findUser(@PathParam("userId") @NotNull Long userId) {
    ...
    public Account createAccount(@PathParam("userId") @NotNull Long userId, @Valid CreateAccountRequest createAccountRequest) {
